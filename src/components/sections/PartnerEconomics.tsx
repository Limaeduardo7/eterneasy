      ...
      <div className="container-x">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-[1fr_1.4fr]">
          <div className="surface p-7">
            <span className="text-xs font-bold uppercase tracking-widest text-gold-400/70">Exemplo prático — plano Flex</span>
            <div className="mt-5 space-y-3">
              <div className="flex items-center justify-between gap-4 border-b border-white/8 pb-3">
                <span className="text-sm text-slate-blue-100/65">4 eventos/mês × ticket R$500</span>
                <span className="font-display text-lg font-bold text-parchment-50">R$2.000</span>
              </div>
              <div className="flex items-center justify-between gap-4 border-b border-white/8 pb-3">
                <span className="text-sm text-slate-blue-100/65">Custo Flex (4 × R$150)</span>
                <span className="font-display text-lg font-bold text-slate-blue-100/60">− R$600</span>
              </div>
              <div className="flex items-center justify-between gap-4 pt-1">
                <span className="text-sm font-bold text-parchment-50">Margem líquida</span>
                <span className="font-display text-2xl font-bold text-gold-300">R$1.400</span>
              </div>
            </div>
            <p className="mt-4 text-xs leading-5 text-slate-blue-100/42">
          ...
          <div className="surface flex flex-col justify-between gap-6 p-7">
            <div>
              <span className="text-xs font-bold uppercase tracking-widest text-gold-400/70">Por que o Premium vale a pena</span>
              <p className="mt-4 font-display text-2xl font-semibold leading-tight text-parchment-50">
                A partir de 4 eventos/mês, R$500 fixo é mais barato que pagar R$150 por cliente.
              </p>
              <p className="mt-4 text-sm leading-7 text-slate-blue-100/65">
