    ...
    <footer className="border-t border-navy-950/8 bg-white py-10">
      <div className="container-x">
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <p className="max-w-sm text-sm leading-6 text-navy-700/55">
            Venda fotos ao vivo, slideshow no telão e lembranças exclusivas para os clientes que você já atende.
          </p>

          <nav className="flex items-center gap-5 text-sm font-semibold text-navy-700/55">
        ...
        <div className="mt-8 flex flex-col justify-between gap-2 border-t border-navy-950/8 pt-6 text-xs text-navy-700/38 sm:flex-row">
